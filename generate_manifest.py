...
def main():
    ...
    # Include the optional prints/ folder so framed prints are optimized too.
    media_inputs = list(categories)
    if prints:
        media_inputs.append({"folder": PRINTS_FOLDER, "images": prints})
    media = build_media(media_inputs)
